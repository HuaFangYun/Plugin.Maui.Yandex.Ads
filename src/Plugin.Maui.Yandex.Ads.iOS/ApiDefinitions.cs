...
namespace Plugin.Maui.Yandex.Ads.iOS
{
	...
	interface YMAAdView
	{
		...
		NativeHandle Constructor (string blockID, YMAAdSize adSize, YMAAdViewDelegate @delegate);
		...
		NativeHandle Constructor (string blockID, CGSize size, YMAAdViewDelegate @delegate);
	...
	interface YMAInterstitialController
	{
		...
		NativeHandle Constructor (string blockID);
	...
	interface YMAAdRequest
	{
		...
		[Verify (StronglyTypedNSArray)]
		NativeHandle Constructor ([NullAllowed] CLLocation location, [NullAllowed] string contextQuery, [NullAllowed] NSObject[] contextTags);
		...
		[Verify (StronglyTypedNSArray)]
		NativeHandle Constructor ([NullAllowed] CLLocation location, [NullAllowed] string contextQuery, [NullAllowed] NSObject[] contextTags, [NullAllowed] NSDictionary parameters);
	}
	...
	interface YMANativeAdLoader
	{
		...
		NativeHandle Constructor (YMANativeAdLoaderConfiguration configuration);
	...
	interface YMANativeAdDelegate
	{
		...
		void NativeAd (NSObject ad, UIViewController viewController);
...
*/[Protocol]
  ...
  be used.
*/[Protocol]
	interface YMANativeContentAd : IYMANativeGenericAd
	{
  ...
  be used.
*/[Protocol]
	interface YMANativeAppInstallAd : IYMANativeGenericAd
	{
  ...
  be used.
*/[Protocol]
	interface YMANativeImageAd : IYMANativeGenericAd
	{
...
*/[Protocol]
	...
	[BaseType (typeof(UIView))]
	interface YMANativeBannerView : IYMANativeAdImageLoadingObserver
	{
	...
	interface YMANativeAdLoaderConfiguration
	{
		...
		NativeHandle Constructor (string blockID, bool shouldLoadImagesAutomatically);
		...
		[DesignatedInitializer]
		[Verify (StronglyTypedNSArray)]
		NativeHandle Constructor (string blockID, NSObject[] imageSizes, bool shouldLoadImagesAutomatically);
	}
	...
	interface YMAVideoAdsRequest : INSCopying, INSMutableCopying
	{
		...
		NativeHandle Constructor (string blockID, YMABlocksInfo blocksInfo, string pageRef, string targetRef);
	...
	partial interface Constants
	{
		// extern double YandexMobileAdsVersionNumber;
		[Field ("YandexMobileAdsVersionNumber", "__Internal")]
		double YandexMobileAdsVersionNumber { get; }

		// extern const unsigned char[] YandexMobileAdsVersionString;
		[Field ("YandexMobileAdsVersionString", "__Internal")]
		byte[] YandexMobileAdsVersionString { get; }
	}
}
